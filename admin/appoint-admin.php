...
<body>
    ...
    if (isset($_SESSION['Admin_ID'])) {
        ...
        $stmt2 = $pdo->prepare("SELECT * FROM registration WHERE Reg_Status='Request Pending'");
        $stmt2->execute(array());
        ...
        while ($row = $stmt2->fetch(PDO::FETCH_ASSOC)) {
            ...
            $avail = $row['Availability_DT'];
            $timeofapp = $row['TimeOfApp'];
            ...
            echo ("<p><b>Availability:</b> $avail</p>" . "\n");
            echo ("<p><b>DateOfAppointment:</b> <input type='date' value='$dateofapp' name='DateOfApp' required='' > </p>" . "\n");
            echo ("<p><b>TimeOfAppointment:</b> <input type='text'name='TimeOfApp' value='$timeofapp' required></p>" . "\n");
            echo ("</br>" . "\n");
            echo ("<input type='hidden' name='Regist_ID' value='$rid'>");
            echo ('<button type="submit" class="submit-btn">Approve</button>');
            echo ("</form>" . "\n");
            echo ("</br>" . "\n");
            echo ("</br>" . "\n");
        }
